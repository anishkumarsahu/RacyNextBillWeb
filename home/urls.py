...
urlpatterns = [
    ...
    url(r'^salesReportJet/$', salesReportJet, name='salesReportJet'),
    ...
    url(r'^contact/customer_ledger_jet/(?P<id>[0-9]+)/$', customer_ledger_jet, name='customer_ledger_jet'),
    ...
    url(r'^JetSalesListByProductJson/$', JetSalesListByProductJson.as_view(), name='JetSalesListByProductJson'),
    url(r'^SalesListJson/$', SalesListJson.as_view(), name='SalesListJson'),
    url(r'^JetSalesListJson/$', JetSalesListJson.as_view(), name='JetSalesListJson'),
    url(r'^SalesListByCustomerJson/$', SalesListByCustomerJson.as_view(), name='SalesListByCustomerJson'),
    url(r'^SalesJetListByCustomerJson/$', SalesJetListByCustomerJson.as_view(), name='SalesJetListByCustomerJson'),
    ...
    url(r'^api/get_jet_sales_detail/(?P<id>[0-9]+)/$', get_jet_sales_detail, name='get_jet_sales_detail'),
    ...
    url(r'^api/delete_sales_jet/$', delete_sales_jet, name='delete_sales_jet'),
    url(r'^api/take_sale_payment/$', take_sale_payment, name='take_sale_payment'),
    url(r'^api/certificate_detail_update/$', certificate_detail_update, name='certificate_detail_update'),
    ...
    # jet to Normal
    url(r'^JetToNormalSale/(?P<id>[0-9]+)/$', JetToNormalSale, name='JetToNormalSale'),
    url(r'^api/add_sales_from_jet_to_normal/$', add_sales_from_jet_to_normal, name='add_sales_from_jet_to_normal'),
]
