# -*- coding: utf-8 -*-
# Generated by Django 1.11.12 on 2020-03-01 11:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isDeleted', models.BooleanField(default=False)),
                ('productID', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='home.Product')),
                ('salesID', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='home.SalesJet')),
            ],
        ),
        migrations.CreateModel(
            name='SalesLater',
