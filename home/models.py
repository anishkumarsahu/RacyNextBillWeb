...
class Customer(models.Model):
    ...
    address = models.TextField(blank=True, null=True, default='')
    email = models.CharField(max_length=200, blank=True, null=True, default='')
    initialBalance = models.FloatField(default=0)
    isDeleted = models.BooleanField(default=False)
    datetime = models.DateTimeField(auto_now_add=True, auto_now=False)
    lastUpdatedOn = models.DateTimeField(auto_now_add=False, auto_now=True)
...
class Supplier(models.Model):
    ...
    address = models.TextField(blank=True, null=True, default='')
    email = models.CharField(max_length=200, blank=True, null=True, default='')
    initialBalance = models.IntegerField(default=0)
    isDeleted = models.BooleanField(default=False)
    datetime = models.DateTimeField(auto_now_add=True, auto_now=False)
    lastUpdatedOn = models.DateTimeField(auto_now_add=False, auto_now=True)
...
class Sales(models.Model):
    ...
    challanNo = models.CharField(max_length=500, blank=True, null=True)
    isCertified = models.CharField(max_length=50,default='No')
    certificateDetail = models.TextField(default='')
...
class SalesJet(models.Model):
    ...
    paidAgainstBill = models.FloatField(default=0.0)
    personalDiscount = models.FloatField(default=0.0)
    isConvertedToNormalSale= models.BooleanField(default=False)
    challanNo = models.CharField(max_length=500, blank=True, null=True)
    def __str__(self):
        return self.customerName

    class Meta:
        verbose_name_plural = 'S)Jet Sales List'


class SalesJetProduct(models.Model):
    salesID = models.ForeignKey(SalesJet, blank=True, null=True)
    productID = models.ForeignKey(Product, blank=True, null=True)
    productName = models.CharField(max_length=200, blank=True, null=True)
    category = models.CharField(max_length=200, blank=True, null=True)
    hsn = models.CharField(max_length=200, blank=True, null=True)
